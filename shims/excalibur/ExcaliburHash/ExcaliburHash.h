...
template <typename TKey, typename TValue, unsigned kNumInlineItems = 1, typename TKeyInfo = KeyInfo<TKey>> class HashTable
{
  ...
  public:
    class IteratorBase
    {
      ...
      public:
        IteratorBase() noexcept // Add default constructor
            : m_ht(nullptr)
            , m_item(nullptr)
        {
        }
    ...
    template <typename TIteratorValue> class TIteratorKV : public IteratorBase
    {
      ...
      public:
        TIteratorKV() noexcept // Add default constructor
            : IteratorBase() // This will call the new IteratorBase default constructor
